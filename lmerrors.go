...
func (e err) ErrorId() int {
	return e.Id
}

func (e err) ErrorDescription() string {
	return e.Description
}

func (e err) ErrorSubject() string {
	return fmt.Sprintf(e.SubjectFmt, e.SubjectArgs...)
}

func (e err) ErrorCause() error {
	return e.Cause
}

func (e err) ErrorFix() string {
	return e.Fix
}

var _ lmerror = err{}

func FormatLmErr(e err) string {
	var f string
	var args []interface{}
...
func lmerrorNew(id int, description string, cause error, fix string, subject string) lmerror {
	return err{id, description, cause, "%s", []interface{}{subject}, fix}
}
func lmerrorNewf(id int, description string, cause error, fix string, subjectf string, subjectArgs ...interface{}) lmerror {
	return err{id, description, cause, subjectf, subjectArgs, fix}
}
